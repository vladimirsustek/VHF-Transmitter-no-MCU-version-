...
xst -ifn xst.scr
move ClockUp_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ClockUp_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ClockUp_exdes.ucf ClockUp_exdes

echo 'Running map'
map -timing -pr b ClockUp_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm ClockUp_exdes -w routed.ncd routed.vhd
cd ..
